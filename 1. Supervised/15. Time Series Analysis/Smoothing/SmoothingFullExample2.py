...
print(rms)  # 0.05163894644523008    span = 5
            # 0.062946980901469583   span = 10
...
rms=sqrt(mean_squared_error(y_test, fcast1))
print(rms) #0.008688376405296643
...
rms=sqrt(mean_squared_error(y_test, fcast1))
print(rms) #0.0021731667046155025
...
print(rms) #0.026953200686077407
...
rms=sqrt(mean_squared_error(y_test, fcast3))
print(rms) # 0.028536951031569172
...
print(rms) # 0.023655482740495833
