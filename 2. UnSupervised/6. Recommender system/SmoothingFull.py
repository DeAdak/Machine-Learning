...
print(rms) # 58.76661998958252  span = 16
           # 71.4970861877135   span = 5
 
####  SimpleExpSmoothing  ########
from statsmodels.tsa.api import SimpleExpSmoothing
alpha = 0.1 # 0 < alpha <= 1
fit1=SimpleExpSmoothing(y_train).fit(smoothing_level=alpha)
fcast1 = fit1.forecast(len(y_test)) #844.843
...
plt.plot(y_train,label='Train')
plt.plot(y_test,label='Test')
plt.plot(fcast5,label="Multiplicative and Damped trend")
plt.legend(loc='best')
plt.show()
