...
bank = pd.read_csv(r"G:\Ddrive\PG DBDA\12 Practical Machine Learning_\Cases\bank\bank.csv",sep=';')
...
log_loss(y_true=y_test,y_pred=y_pred_prob) #0.2210152885294297
...
print(f"Accuracy: {acc}") #Accuracy: 0.9071481208548269
...
from sklearn.metrics import log_loss
y_pred_prob = model.predict(X_test)
log_loss(y_true=y_test,y_pred=y_pred_prob) #0.22213509367349568
...
acc = accuracy_score(y_test,predict_classes)
print(f"Accuracy: {acc}") #Accuracy: 0.9049373618275608